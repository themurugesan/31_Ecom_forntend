  ...
  const handleUpload = async (e) => {
    ...
    try {
      if (editMode && currentImageId) {
        ...
        await axios.put(
          `${process.env.REACT_APP_SERVER ? process.env.REACT_APP_SERVER : window.location.origin}/images/${currentImageId}`,
          formData
        );
      } else {
        // Create a new image
        await axios.post(`${process.env.REACT_APP_SERVER ? process.env.REACT_APP_SERVER : window.location.origin}/api/admins/upload`, formData);
      }
